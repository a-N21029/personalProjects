...
const Places = ({setLocation, placeholder}) => {
  ...
  return (
    ...
    <Combobox onSelect={handleSelect} style={{"marginBottom": "10%"}}>
        <ComboboxInput value={value} onChange={e => setValue(e.target.value)} className="combobox-input" placeholder={placeholder}/>
            <ComboboxPopover>
                <ComboboxList>
